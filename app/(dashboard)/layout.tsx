...
import { LayoutDashboard, Bell, Users, Map, Settings, LogOut, Shield, Menu, X } from "lucide-react"
...
export default function DashboardLayout({
  ...
  const filteredNavItems = navItems.filter((item) => item.roles.includes(role as "owner" | "receptionist"))
